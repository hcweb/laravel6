...
<div class="tab-content">
    <div class="tab-pane fade active show" id="base">
        <div class="row form-group">
            <label class="col-sm-2 text-right col-form-label"><i style="color: red;margin-right: 10px;">*</i>标题</label>
            <div class="col-sm-4">
        ...
        <div class="form-group row">
            <label  class="col-sm-2 col-form-label text-right">内容详情</label>
