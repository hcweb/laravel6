        ...
        layui.use(['table', 'jquery','layer'], function () {
            ...
            var dataTable=table.render({
                ...
                cols: [[
                    ...
                    // , {field: 'is_slide', width: 80,title: '幻灯',templet:function (res) {
                    //         if (res.is_slide == 1){
                    //             return '<input type="checkbox" name="switch" lay-skin="switch" checked disabled>';
                    //         }
                    //         return '<input type="checkbox" name="switch" lay-skin="switch" disabled>';
                    //     }}
                    // , {field: 'is_tuijian', width: 80,title: '推荐',templet:function (res) {
                    //         if (res.is_tuijian == 1){
                    //             return '<input type="checkbox" name="switch" lay-skin="switch" checked disabled>';
                    //         }
                    //         return '<input type="checkbox" name="switch" lay-skin="switch" disabled>';
                    //     }}
                    // , {field: 'is_top', width: 80,title: '置顶',templet:function (res) {
                    //         if (res.is_top == 1){
                    //             return '<input type="checkbox" name="switch" lay-skin="switch" checked disabled>';
                    //         }
                    //         return '<input type="checkbox" name="switch" lay-skin="switch" disabled>';
                    //     }}
                    // , {field: 'is_hot', width: 80,title: '热门',templet:function (res) {
                    //         if (res.is_hot == 1){
                    //             return '<input type="checkbox" name="switch" lay-skin="switch" checked disabled>';
                    //         }
                    //         return '<input type="checkbox" name="switch" lay-skin="switch" disabled>';
